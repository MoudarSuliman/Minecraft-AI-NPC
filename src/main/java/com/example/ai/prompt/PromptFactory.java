...
public final class PromptFactory {
    ...
    private static final String ACTION_SELECTION_RULES_PENDING =
            "Never return idle when has_pending_instruction is true.\n"
                ...
                + "14. Message clearly wants an ACTION but is too vague to act on — an unresolved pronoun with no referent ('do it', 'use those', 'the same again' when nothing has been discussed) -> ask_clarification with parameters {\"text\":\"<one short question asking what they mean>\"}. NEVER use ask_clarification for conversation, greetings, small talk, opinions, or any question the NPC can simply answer — those are always dialogue_reply.\n"
