...
public final class PromptFactory {
    ...
    private static final String ACTION_SELECTION_RULES_PENDING =
            "Never return idle when has_pending_instruction is true.\n"
                ...
                + "8. Direct imperative order to build/construct/place/set up a structure (floor, wall, hut, house, shelter, platform, pattern of blocks) -> build_structure with parameters {\"description\":\"<the full instruction text>\"}. Anything phrased as a QUESTION — 'can you build?', 'can you build a pillar?', 'could you build a house?', 'do you know how to build X?' — is dialogue_reply: answer and ask whether they want it built. A direct imperative build order is NEVER dialogue_reply or recipe_reply.\n"
                ...
                + "'build me a hut with cobble stone' -> build_structure. 'make me a small shelter' -> build_structure. 'can you build?' -> dialogue_reply. 'can you build a pillar?' -> dialogue_reply. 'yes, do it' (previous_instruction='can you build a pillar?') -> build_structure.\n"
