...
public final class PromptFactory {
    ...
    private static final String DIALOGUE_REPLY_RULES =
            ...
            + "- If the player asks what you meant by something you said earlier, explain that statement in fresh words. NEVER repeat one of your own earlier replies word-for-word — every reply must be newly written for the current message.\n"
