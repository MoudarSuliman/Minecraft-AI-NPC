...
public final class AgentDecisionParser {
    ...
    public String toJsonSchema() {
        ...
        properties.addProperty("intent", "string enum: idle|dialogue_reply|ask_clarification|cancel_task|confirm_yes|confirm_no|recipe_reply|scout_explorer|move_to|fetch_from_chest|mine_block|mine_to_chest|mine_to_player|trade_offer|trade_accept|trade_decline|trade_counter|place_block|break_block|build_structure");
    ...
    private AgentIntentType parseIntent(String raw) {
        ...
        return switch (normalized) {
            ...
            case "ASK_CLARIFICATION" -> AgentIntentType.ASK_CLARIFICATION;
            case "CANCEL_TASK" -> AgentIntentType.CANCEL_TASK;
            case "CONFIRM_YES" -> AgentIntentType.CONFIRM_YES;
            case "CONFIRM_NO" -> AgentIntentType.CONFIRM_NO;
